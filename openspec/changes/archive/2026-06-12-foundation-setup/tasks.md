...
> **Nota**: 9.2 requiere PostgreSQL real (docker-compose up). Saltos de DB (test_database.py, test_health_db_up) necesitan `_TEST_DB_AVAILABLE=1` o `CI=1` + `DATABASE_URL` real.
